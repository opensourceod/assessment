...
export default function GapReport() {
  ...
  if (cargando) {
    return <div className="min-h-screen flex items-center justify-center"><p className="text-muted">Loading report...</p></div>
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto py-10 px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-8">
          <div>
            <p className="text-primary text-xs font-semibold uppercase tracking-widest mb-1">Gap Analysis Report</p>
        ...
        {reporte.evaluadores_completados === 0 && (
          <div className="card bg-cyan-50 border-cyan-200 mb-6">
            <p className="text-sm text-dark">
              No evaluator responses yet. The radar chart will appear once at least one evaluator completes the survey.
            </p>
          </div>
        )}
